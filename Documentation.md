# Valor Library
This documentation is for the stable release of Valor Library.

## Booting the Library
```lua
local ValorLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/LibertyWalk999/Valor/main/source')))()
```
...
## Creating a Window
```lua
local Window = ValorLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "ValorTest"})
...
print(ValorLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
